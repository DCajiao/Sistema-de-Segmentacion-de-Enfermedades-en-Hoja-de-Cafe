...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Toma una foto y diagnostica enfermedades del aguacate al instante con inteligencia artificial." },
      ...
      { name: "twitter:description", content: "Toma una foto y diagnostica enfermedades del aguacate al instante con inteligencia artificial." },
